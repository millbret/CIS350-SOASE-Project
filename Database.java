...
public class Database {
    ...
    /** Holds the Paris ship*/
    private Ship Paris;

    /** Holds the Punic ship*/
    private Ship Punic;

    /** Holds the Marathon ship*/
    private Ship Marathon;
...
//    private String search;
    ...
    public Database() {
         ...
         ************************************************/
        this.Paris = new Ship("Paris","Frigate","Light","UNSC",5,355,
                40, 5,10,5,1800,3, 0,0,
                4, 22,700,0,2);
        this.Punic = new Ship("Punic","Carrier","VeryHeavy","UNSC",75,5500,
                1000,1150,110,50,
                16000,24,0,0,
                14, 269,500,24,5);
        this.Marathon = new Ship("Marathon","Cruiser","Medium","UNSC",25,950,
                250,90,45,50,6000,10, 0,0,
                7, 132,600,3,4);
        this.CCS = new Ship("CCS","Cruiser","Medium","Coevenant",21,1650,
                220,90,35,21,4400,5, 12000,600, 3,
                130,700,16,3);
        this.CAS = new Ship("CAS","Carrier","VeryHeavy","Covenant",100,10000,
